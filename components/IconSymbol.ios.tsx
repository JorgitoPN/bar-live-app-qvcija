 ...
 * 
 * ✅ INSTAGRAM-STYLE v19.0.0: FIXED - Uses icon name directly from TabIcon
...
export function IconSymbol({
  ...
  console.log(`🎨 [IconSymbol iOS v19.0] ${name}, ${isFilled ? 'FILLED' : 'OUTLINED'}, mode: ${renderingMode}, color: ${color}`);
