...
export default function ExplorarScreen() {
  ...
  const handleScroll = (event: any) => {
    ...
    // FIXED: Hide header and categories together when scrolling down
  ...
  return (
    <View style={styles.container}>
      {/* Animated Header + Categories Container - STICKY TOGETHER */}
      <Animated.View
        style={{
          position: 'absolute',
          top: 0,
      ...
      >
        ...
        {/* Categories - ATTACHED TO HEADER */}
        <View style={styles.categoriasContainer}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {CATEGORIAS_LOCALES.map((categoriaNow I understand the issues. Let me fix them:

1. **Category Filters Position**: The filters are positioned absolutely but they start at `top: HEADER_HEIGHT` which means they're initially covered by the header. They need to be visible when the page loads and only hide/show with scroll.

2. **Navigation Speed**: The navigation is using `router.replace()` but there's still a delay. We need to ensure the navigation is truly instant by removing any animation delays and optimizing the tab switching.
