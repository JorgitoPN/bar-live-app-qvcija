...
/**
 * ✅ PROFILE SCREEN v340.0 - ELIMINACIÓN TOTAL DEL MARGEN BLANCO
 * 
 * CAMBIOS v340.0:
  ...
  return (
    <View style={commonStyles.container}>
      ...
      >
        ...
        {/* ✅ FIX v340.0: paddingBottom = 0 para eliminar TODO el espacio entre header y pestañas */}
        <LinearGradient
          colors={[colors.headerGradientStart, colors.headerGradientEnd]}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 0 }}
...
const styles = StyleSheet.create({
  ...
  // ✅ FIX v340.0: paddingBottom = 16 para mantener el espacio interno del contenido
  profileSection: {
    paddingTop: 0,
    paddingBottom: 16,
  },
