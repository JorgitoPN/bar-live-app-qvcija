 ...
 * - ✅ Removed white background box from "Reclama tu local" banner
 * - ✅ Text now displays directly on gradient (transparent background)
...
export default function ExplorarScreen() {
  ...
  return (
    <View style={commonStyles.container}>
      ...
      >
        {/* ✅ CRITICAL FIX v99.0: Banner with NO white background - text directly on gradient */}
        <TouchableOpacity 
        ...
        >
          ...
          >
            <View style={styles.claimLocalContent}>
              ...
              {/* ✅ CRITICAL FIX v99.0: Text container with NO white background */}
...
const styles = StyleSheet.create({
  ...
  claimLocalTextContainer: {
    flex: 1,
    minWidth: 0,
    // ✅ CRITICAL FIX v99.0: NO white background - transparent
