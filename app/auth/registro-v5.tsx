...
export default function RegistroV5Screen() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      console.log('[Registro v5.0] 📝 Registering new user:', normalizedEmail);
      ...
      if (checkError && checkError.code !== 'PGRST116') {
        console.error('[Registro v5.0] Error checking email:', checkError);
            ...
            [
              {
                ...
                onPress: async () => {
                  try {
                    ...
                    console.error('[Registro v5.0] Error resending email:', err);
      ...
      if (authError) {
        console.error('[Registro v5.0] ❌ Error creating auth user:', authError);
      ...
      console.log('[Registro v5.0] ✅ User created successfully:', authData.user.id);
      ...
      console.error('[Registro v5.0] ❌ Error in handleRegister:', error);
