...
/**
 * 🔐 SECURE REGISTRATION SCREEN v2.0 - INTELLIGENT REDIRECT FLOW COMPLETELY FIXED
 * 
 * CRITICAL FIXES v2.0:
 * - ✅ FIXED: Redirect parameter now properly decoded with decodeURIComponent
 * - ✅ FIXED: Passes decoded redirect to verification screen
 ...
 * 6. ✅ NEW v2.0: Redirect to verification screen with properly decoded redirect param
 */
...
export default function SecureRegistrationScreen() {
  ...
  // ✅ v2.0: CRITICAL FIX - Properly decode redirect parameter
  ...
  console.log('[SecureRegistration v2.0] 🔄 Raw redirect param:', redirectPath);
  console.log('[SecureRegistration v2.0] 🔄 Decoded redirect path:', decodedRedirectPath);
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      console.log('[SecureRegistration v2.0] 🔐 Creating secure account:', normalizedEmail);
      ...
      if (authError) {
        console.error('[SecureRegistration v2.0] ❌ Registration error:', authError);
          ...
          Alert.alert(
            ...
            [
              { text: 'Cancelar', style: 'cancel' },
              {
                text: 'Iniciar sesión',
                onPress: () => {
                  // ✅ v2.0: Pass properly encoded redirect parameter to login screen
                  if (redirectPath) {
                    console.log('[SecureRegistration v2.0] 🎯 Passing redirect to login:', redirectPath);
                    router.replace({
      ...
      console.log('[SecureRegistration v2.0] ✅ Account created successfully:', authData.user.id);
        ...
        [
          {
            text: 'Entendido',
            onPress: () => {
              // ✅ v2.0: CRITICAL FIX - Pass properly encoded redirect path to verification screen
              if (redirectPath) {
                console.log('[SecureRegistration v2.0] 🎯 Passing redirect to verification:', redirectPath);
                console.log('[SecureRegistration v2.0] 🎯 Decoded path:', decodedRedirectPath);
      ...
      console.error('[SecureRegistration v2.0] ❌ Unexpected error:', error);
