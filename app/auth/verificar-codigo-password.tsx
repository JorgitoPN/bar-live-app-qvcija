...
export default function VerificarCodigoPasswordScreen() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (userError || !userData) {
        console.error('[VerificarCodigoPassword] Error getting user:', userError);
      ...
      console.log('[VerificarCodigoPassword] ✅ Code verified successfully');
      ...
      console.error('[VerificarCodigoPassword] ❌ Error in handleVerify:', error);
  ...
  const handleResendCode = async () => {
    ...
    try {
      ...
      if (updateError) {
        console.error('[VerificarCodigoPassword] Error updating verification code:', updateError);
      ...
      if (emailError) {
        console.error('[VerificarCodigoPassword] Error sending verification email:', emailError);
        Alert.alert(
          'Advertencia',
      ...
      console.error('[VerificarCodigoPassword] ❌ Error resending code:', error);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.headerSubtitle}>Ingresa el código recibido</Text>
      </LinearGradient>
