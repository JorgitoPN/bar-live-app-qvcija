...
export default function RecuperarPasswordV6Screen() {
  ...
  const handleSendResetEmail = async () => {
    ...
    try {
      ...
      console.log('═══════════════════════════════════════════════════════');
      console.log('[RecuperarPasswordV6] 🔍 INICIO DE PROCESO DE RECUPERACIÓN');
      console.log('═══════════════════════════════════════════════════════');
            ...
            <>
              ...
              <View style={styles.instructionsBox}>
                ...
                <View style={styles.stepItem}>
                  ...
                  <View style={styles.stepContent}>
                    <Text style={styles.stepTitle}>Haz clic en el botón</Text>
                    <Text style={styles.stepText}>Presiona &quot;Restablecer contraseña&quot; en el correo</Text>
                  </View>
                </View>
