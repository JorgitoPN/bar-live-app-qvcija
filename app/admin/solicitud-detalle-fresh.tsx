...
export default function SolicitudDetalleFreshScreen() {
  ...
  console.log('[FreshAdminDetail] 🎬 Pantalla inicializada');
  console.log('[FreshAdminDetail] 📋 ID:', solicitudId);

  const loadSolicitud = useCallback(async () => {
    try {
      console.log('[FreshAdminDetail] 📥 Cargando solicitud...');
  ...
  const executeAction = async () => {
    ...
    try {
      if (actionType === 'aprobar') {
        console.log('[FreshAdminDetail] ✅ Aprobando solicitud...');
        ...
        console.log('[FreshAdminDetail] ❌ Denegando solicitud...');
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerSubtitle}>Fresh System v5.0</Text>
        </View>
        <View style={{ width: 40 }} />
      </LinearGradient>
