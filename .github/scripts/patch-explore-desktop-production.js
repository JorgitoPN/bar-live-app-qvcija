...
for (const needle of ['Ver local','Desplázate para ver más','nearbyScroll','selectedVenue:Z','embedded:!0','Ubicación seleccionada']) {
...
const stamp = 'explore-fixed-20260926-4';
