...
replaceModule(1252, (desktop) => {
  desktop = replaceOnce(
    ...
    "const Q=(0,x.useRouter)(),{user:blUser}=r(1024).useAuth(),{isFavorite:blIsFavorite,toggleFavorite:blToggleFavorite}=r(1025).useFavorites(),[U,J]=(0,t.useState)([]),[K,Y]=(0,t.useState)(!0),[Z,$]=(0,t.useState)(null),[tt,nt]=(0,t.useState)(0),rt=(0,t.useRef)(null),it=(0,t.useRef)(!1);",
    'desktop state'
  );
  ...
  // v9: province selector wired to the existing Zustand filters (no paid APIs)
  // and full-width header background that escapes the centered content column
  // without moving the existing header controls.
  desktop = replaceOnce(
    desktop,
    "const Q=(0,x.useRouter)(),{user:blUser}=r(1024).useAuth(),{isFavorite:blIsFavorite,toggleFavorite:blToggleFavorite}=r(1025).useFavorites(),[U,J]=(0,t.useState)([]),[K,Y]=(0,t.useState)(!0),[Z,$]=(0,t.useState)(null),[tt,nt]=(0,t.useState)(0),rt=(0,t.useRef)(null),it=(0,t.useRef)(!1);",
    "const Q=(0,x.useRouter)(),{user:blUser}=r(1024).useAuth(),{isFavorite:blIsFavorite,toggleFavorite:blToggleFavorite}=r(1025).useFavorites(),blStore=r(1036).useFilterStore,blFiltros=blStore(e0=>e0.filtros),blSetFiltros=blStore(e0=>e0.setFiltros),blDynamicProvinces=blStore(e0=>e0.dynamicOptions?.provincias||[]),[blProvinceOpen,blSetProvinceOpen]=(0,t.useState)(!1),[U,J]=(0,t.useState)([]),[K,Y]=(0,t.useState)(!0),[Z,$]=(0,t.useState)(null),[tt,nt]=(0,t.useState)(0),rt=(0,t.useRef)(null),it=(0,t.useRef)(!1);",
    'province store state'
  );

  desktop = replaceOnce(
    desktop,
    "te=(0,t.useMemo)(()=>Array.from(new Map(e.filter(e=>e?.id).map(e=>[String(e.id),e])).values()),[e]),oe=w(ee),re=e=>{e?.id&&Q.push('/detalle/local?id='+e.id)},",
    "te=(0,t.useMemo)(()=>Array.from(new Map(e.filter(e=>e?.id).map(e=>[String(e.id),e])).values()),[e]),blProvinceOptions=(0,t.useMemo)(()=>{const e0=blDynamicProvinces?.length?blDynamicProvinces:['A Coruña','Álava','Albacete','Alicante','Almería','Asturias','Ávila','Badajoz','Barcelona','Bizkaia','Burgos','Cáceres','Cádiz','Cantabria','Castellón','Ceuta','Ciudad Real','Córdoba','Cuenca','Gipuzkoa','Girona','Granada','Guadalajara','Huelva','Huesca','Illes Balears','Jaén','La Rioja','Las Palmas','León','Lleida','Lugo','Madrid','Málaga','Melilla','Murcia','Navarra','Ourense','Palencia','Pontevedra','Salamanca','Santa Cruz de Tenerife','Segovia','Sevilla','Soria','Tarragona','Teruel','Toledo','Valencia','Valladolid','Zamora','Zaragoza'];return Array.from(new Set(e0.filter(Boolean))).sort((a0,n0)=>String(a0).localeCompare(String(n0),'es',{sensitivity:'base'}))},[blDynamicProvinces]),blSelectedProvince=blFiltros?.provincia||null,blSelectProvince=(0,t.useCallback)(e0=>{const n0={...(blFiltros||{})};e0?n0.provincia=e0:delete n0.provincia;blSetFiltros(n0);blSetProvinceOpen(!1)},[blFiltros,blSetFiltros]),oe=w(ee),re=e=>{e?.id&&Q.push('/detalle/local?id='+e.id)},",
    'province selector logic'
  );

  desktop = replaceOnce(
    desktop,
    "(0,C.jsxs)(y.default,{style:R.topHeader,children:[\n(0,C.jsxs)(y.default,{style:R.headerMainRow,children:[",
    "(0,C.jsxs)(y.default,{style:R.topHeader,children:[\n(0,C.jsx)(y.default,{pointerEvents:'none',style:R.headerBackdrop}),\n(0,C.jsxs)(y.default,{style:R.headerMainRow,children:[",
    'header backdrop render'
  );

  desktop = replaceOnce(
    desktop,
    "(0,C.jsxs)(h.default,{style:R.locationSelector,onPress:O,activeOpacity:.8,children:[(0,C.jsx)(b.IconSymbol,{ios_icon_name:\"location.fill\",android_material_icon_name:\"location_on\",size:18,color:\"#4F638C\"}),(0,C.jsx)(u.default,{style:R.locationSelectorText,numberOfLines:1,children:\"Cerca de ti\"}),(0,C.jsx)(b.IconSymbol,{ios_icon_name:\"chevron.down\",android_material_icon_name:\"expand_more\",size:15,color:\"#4F638C\"})]}),",
    "(0,C.jsxs)(y.default,{style:R.locationSelectorWrap,children:[(0,C.jsxs)(h.default,{style:[R.locationSelector,blProvinceOpen&&R.locationSelectorOpen],onPress:()=>blSetProvinceOpen(e0=>!e0),activeOpacity:.8,children:[(0,C.jsx)(b.IconSymbol,{ios_icon_name:\"location.fill\",android_material_icon_name:\"location_on\",size:18,color:\"#4F638C\"}),(0,C.jsx)(u.default,{style:R.locationSelectorText,numberOfLines:1,children:blSelectedProvince||\"Cerca de ti\"}),(0,C.jsx)(b.IconSymbol,{ios_icon_name:blProvinceOpen?\"chevron.up\":\"chevron.down\",android_material_icon_name:blProvinceOpen?\"expand_less\":\"expand_more\",size:15,color:\"#4F638C\"})]}),blProvinceOpen?(0,C.jsxs)(y.default,{style:R.provinceDropdown,children:[(0,C.jsx)(u.default,{style:R.provinceDropdownTitle,children:\"Provincia\"}),(0,C.jsxs)(s.default,{style:R.provinceList,showsVerticalScrollIndicator:!0,children:[(0,C.jsxs)(h.default,{style:[R.provinceOption,!blSelectedProvince&&R.provinceOptionActive],onPress:()=>blSelectProvince(null),activeOpacity:.8,children:[(0,C.jsx)(b.IconSymbol,{ios_icon_name:\"location.fill\",android_material_icon_name:\"my_location\",size:16,color:blSelectedProvince?\"#64748B\":\"#0EA5A8\"}),(0,C.jsx)(u.default,{style:[R.provinceOptionText,!blSelectedProvince&&R.provinceOptionTextActive],children:\"Cerca de ti\"})]}),...blProvinceOptions.map(e0=>{const n0=blSelectedProvince===e0;return(0,C.jsxs)(h.default,{style:[R.provinceOption,n0&&R.provinceOptionActive],onPress:()=>blSelectProvince(e0),activeOpacity:.8,children:[(0,C.jsx)(u.default,{style:[R.provinceOptionText,n0&&R.provinceOptionTextActive],children:e0}),n0?(0,C.jsx)(b.IconSymbol,{ios_icon_name:\"checkmark\",android_material_icon_name:\"check\",size:16,color:\"#0EA5A8\"}):null]},e0)})]})]}):null]}),",
    'province selector render'
  );

  desktop = replaceOnce(
    desktop,
    "root:{flex:1,width:\"100%\",minWidth:0,minHeight:0,overflow:\"hidden\",backgroundColor:\"#F7FAF9\"},topHeader:{backgroundColor:\"#FFFFFF\",",
    "root:{flex:1,width:\"100%\",minWidth:0,minHeight:0,overflow:\"visible\",backgroundColor:\"#F7FAF9\"},topHeader:{position:\"relative\",backgroundColor:\"transparent\",",
    'full width root/header'
  );

  desktop = replaceOnce(
    desktop,
    "shadowOpacity:.025,shadowRadius:10,zIndex:20},headerMainRow:",
    "shadowOpacity:.025,shadowRadius:10,zIndex:20},headerBackdrop:{position:\"absolute\",top:0,bottom:0,left:-5000,right:-5000,backgroundColor:\"#FFFFFF\",borderBottomWidth:1,borderBottomColor:\"#E8EEF2\"},headerMainRow:",
    'header backdrop style'
  );

  desktop = replaceOnce(
    desktop,
    "locationSelector:{width:200,height:44,",
    "locationSelectorWrap:{width:200,position:\"relative\",zIndex:200},locationSelector:{width:\"100%\",height:44,",
    'location wrapper style'
  );

  desktop = replaceOnce(
    desktop,
    "locationSelectorText:{flex:1,color:\"#26385E\",fontSize:11,fontWeight:\"800\"},filtersPrimary:",
    "locationSelectorOpen:{borderColor:\"#B9DCD8\"},locationSelectorText:{flex:1,color:\"#26385E\",fontSize:11,fontWeight:\"800\"},provinceDropdown:{position:\"absolute\",top:50,right:0,width:260,maxHeight:360,borderRadius:12,borderWidth:1,borderColor:\"#DFE7ED\",backgroundColor:\"#FFFFFF\",paddingTop:10,paddingBottom:8,shadowColor:\"#0F172A\",shadowOffset:{width:0,height:8},shadowOpacity:.14,shadowRadius:22,elevation:12,overflow:\"hidden\",zIndex:500},provinceDropdownTitle:{color:\"#14244A\",fontSize:11,fontWeight:\"900\",paddingHorizontal:13,paddingBottom:8},provinceList:{maxHeight:315},provinceOption:{minHeight:38,paddingHorizontal:13,flexDirection:\"row\",alignItems:\"center\",justifyContent:\"space-between\",gap:8},provinceOptionActive:{backgroundColor:\"#ECFBF8\"},provinceOptionText:{flex:1,color:\"#526384\",fontSize:11,fontWeight:\"700\"},provinceOptionTextActive:{color:\"#0F8F88\",fontWeight:\"900\"},filtersPrimary:",
  ...
  desktop = replaceOnce(
    ...
    "workspace:{flex:1,minHeight:0,overflow:\"hidden\",flexDirection:\"row\",",
    'workspace overflow'
  );
...
if (desktopCheck.includes("const t=w(e),o=I(e),a=Number(")) throw new Error("Desktop Explore shadows the Image module with rating variable");
if (!desktopCheck.includes("blRating=Number(")) throw new Error("Desktop Explore rating variable fix missing");
...
const stamp = 'explore-fixed-20260926-9';
