...
replaceModule(1252, (desktop) => {
  ...
  // but replace the legacy card grid/layout with the new two-pane workspace.
  {
    ...
    const styleStart = desktop.indexOf("const R=c.default.create({", displayIndex);
